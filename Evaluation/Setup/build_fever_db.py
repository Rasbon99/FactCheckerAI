...
def build_wikipedia_database():
    print(f"Starting Phase 1: Building Wikipedia Database from {WIKIPEDIA_FOLDER}...")
    ...
    if not jsonl_files:
        print(f"Error: Could not find any .jsonl files in {WIKIPEDIA_FOLDER}")
        return
    ...
    print(f"Total Wikipedia Pages Indexed: {total_articles:,}")
